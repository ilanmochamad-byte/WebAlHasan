...
<div class="col-12 col-lg-3"><label class="form-label" for="case-privacy">Kerahasiaan</label><select class="form-select" id="case-privacy" name="kerahasiaan"><option>Rahasia</option><option <?= ($input['kerahasiaan']??'')==='Internal'?'selected':'' ?>>Internal</option></select></div>
