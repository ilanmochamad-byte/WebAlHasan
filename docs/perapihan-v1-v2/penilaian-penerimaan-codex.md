...
Rekap terkini: **75 TERVERIFIKASI**, **0 TIDAK TERVERIFIKASI**, **2 MENUNGGU VERIFIKASI**. Belum lulus paket. Riwayat: audit awal 57/4/16; sesudah B-1/A-06/A-07/API menjadi 60/3/14; sesudah kamar/pagination menjadi 63/0/14. Lanjutan verifikasi 14 klaim menutup 12 klaim pada cakupan sandbox. Bukti terakhir: [audit-14-klaim.md](audit-14-klaim.md). A-17 telah dikoreksi sesuai izin pengguna: 45/45 matriks PDF dan 175/175 regresi cetak lulus. Bukti terbaru: [audit-koreksi-pdf-a17.md](audit-koreksi-pdf-a17.md); sisa dua klaim membutuhkan pembaca layar/cetak Safari nyata.
...
| K5-07 | Filter yang sama berlaku pada ringkasan, detail, CSV, dan cetak/PDF | **TERVERIFIKASI** | 432 kombinasi admin/guru × scope × status × tanggal × filter kelas/tahun/jadwal/guru dibandingkan dengan oracle independen: summary, baris detail layar, CSV, dan baris cetak sama. Sembilan PDF nyata memuat data yang sama; sesudah koreksi A-17 seluruh 45 pemeriksaan PDF lulus, kata status potret utuh. Detail pertemuan tetap snapshot lengkap, bukan tabel baris detail laporan. |
...
| K6-16 | Halaman cetak/PDF tetap tanpa sidebar, margin dan pagination tidak berubah | **MENUNGGU VERIFIKASI** | A-17 telah dikoreksi dengan izin pengguna; 175 regresi PDF lama dan 45 pemeriksaan atas sembilan PDF matriks lulus, termasuk kata Terlambat utuh pada ketiga PDF potret. Data, margin dan nomor halaman benar tanpa sidebar pada Chromium. PDF Safari nyata tersimpan/perangkat fisik belum tersedia; Chromium tidak membuktikan Safari. Lihat audit-koreksi-pdf-a17.md. |
...
| Audit Codex seluruh paket | **MENUNGGU VERIFIKASI** | 75 dari 77 klaim terverifikasi pada cakupan bukti; dua klaim pembaca layar/cetak Safari nyata masih menunggu; koreksi A-17 telah disetujui dan diverifikasi pada Chromium. Paket belum ditutup dan tidak mendapat izin push/merge/deploy. |
